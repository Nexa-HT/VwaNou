...
const FloatingActions: React.FC<Props> = ({ is3DMode = false, toggle3D }) => {
  return (
    <div className="vwanou-fab-container">
      ...
      <Link to="/report" className="fab fab-report" aria-label="Rapòte yon ensidan" title="Rapòte yon ensidan">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
